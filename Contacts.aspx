    ...
    <div>
        ...
        <asp:GridView ID="myGridview" runat="server" AutoGenerateColumns="false"
            ...
            <Columns>
                ...
                <asp:TemplateField>
                    <HeaderTemplate>Pais</HeaderTemplate>
                    ...
                    <EditItemTemplate>
                        <asp:DropDownList ID="ddCountry" runat="server" AutoPostBack="true" 
                            ...
                            <asp:ListItem Text="Selecciona Pais" Value="0"></asp:ListItem>
                        </asp:DropDownList>
                    ...
                    <FooterTemplate>
                        ...
                        <asp:RequiredFieldValidator ID="rfC" runat="server" ErrorMessage="*"
                            ForeColor="Red" Display="Dynamic" ValidationGroup="Add" ControlToValidate="ddCountry" 
                            InitialValue="0">Requerido</asp:RequiredFieldValidator>
                    </FooterTemplate>
                </asp:TemplateField>
                <asp:TemplateField>
                    ...
                    <EditItemTemplate>
                        <asp:DropDownList ID="ddState" runat="server">
                            <asp:ListItem Text="Selecciona Estado" Value="0"></asp:ListItem>
                        </asp:DropDownList>
                ...
                <asp:TemplateField>
                    <ItemTemplate>
                        <asp:LinkButton ID="lbEdit" runat="server" CommandName="Edit">Editar</asp:LinkButton>
                        &nbsp;|&nbsp;
                        <asp:LinkButton ID="lbDelete" runat="server" CommandName="Delete" OnClientClick="return confirm('Estas Seguro?')">Borrar</asp:LinkButton>
                    </ItemTemplate>
                    <EditItemTemplate>
                        <asp:LinkButton ID="lbUpdate" runat="server" CommandName="Update" ValidationGroup="edit">Actualizar</asp:LinkButton>
                        &nbsp;|&nbsp;
                        <asp:LinkButton ID="lbCancel" runat="server" CommandName="Cancel">Cancelar</asp:LinkButton>
                    </EditItemTemplate>
                    <FooterTemplate>
                        <asp:Button ID="btnInsert" runat="server" Text="Guardar" CommandName="Insert" ValidationGroup="Add" />
                    </FooterTemplate>
                </asp:TemplateField>
            </Columns>
