...
namespace DXMVCWebApplication1.Controllers
{
    ...
    public class ReporteAnexoTecnico3UController : Controller
    {
        DB_SENASICAEntities db = new DB_SENASICAEntities();

        Reports.ReporteAnexoTecnicoApendice3U reporte = new Reports.ReporteAnexoTecnicoApendice3U();
        Reports.ReporteAnexoTecnicoApendice3U2018 reporte2018 = new Reports.ReporteAnexoTecnicoApendice3U2018();
