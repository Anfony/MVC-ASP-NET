...
{
    [Authorize]
    public class ReporteCampaniaSanidadVegetalController : Controller
    {
        //
        // GET: /ReporteCampaniaSanidadVegetal/
        ...
        Reports.ReporteCampaniaSanidadVegetal report = new Reports.ReporteCampaniaSanidadVegetal();
