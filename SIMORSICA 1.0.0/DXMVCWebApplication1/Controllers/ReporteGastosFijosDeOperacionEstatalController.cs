...
namespace DXMVCWebApplication1.Controllers
{
    ...
    public class ReporteGastosFijosDeOperacionEstatalController : Controller
    {
        DB_SENASICAEntities db = new DB_SENASICAEntities();
        //
        // GET: /ReporteGastosFijosDeOperacionEstatal/
        ...
        Reports.ReporteProgramaIntegralEstatal report = new Reports.ReporteProgramaIntegralEstatal();
        
        public ActionResult ReportPartial1(string ComboComite)
        {
            ...
            return PartialView("_ReportPartial1",report);    
        }
