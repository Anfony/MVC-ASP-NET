...
namespace DXMVCWebApplication1.Controllers
{
    ...
    public class ReporteAnexoTecnico1Controller : Controller
    {
        DB_SENASICAEntities db = new DB_SENASICAEntities();
        DXMVCWebApplication1.Reports.ReporteAnexoTecnicoApendice1 reporte = new Reports.ReporteAnexoTecnicoApendice1();
        DXMVCWebApplication1.Reports.ReporteAnexoTecnicoApendice1_2018 reporte_2018 = new Reports.ReporteAnexoTecnicoApendice1_2018();
        ...
        public ActionResult reporteAnexoTecnicoApendice1(string ComboEstado)
        {
            ...
            if (IdAnio == 5)  //2018
            {
                reporte_2018.Parameters["parameterEstado"].Visible = false;
                reporte_2018.Parameters["parameterEstado"].Value = IdEstado;
                reporte_2018.Parameters["parameterAnio"].Visible = false;
                reporte_2018.Parameters["parameterAnio"].Value = IdAnio;
                return PartialView("_ReporteAnexoTecnicoApendice1Partial", reporte_2018);
            }
            else
            {
                ...
                return PartialView("_ReporteAnexoTecnicoApendice1Partial", reporte);
            }
        }
        ...
        public ActionResult ReportPartialExport(string ComboEstado)
        {
            ...
            if (IdAnio == 5)
                return DocumentViewerExtension.ExportTo(reporte_2018, Request);
            else
